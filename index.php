...
<html class="no-js" lang="en">
    ...
    <div style="height:100%; margin-top: 0px; background: url('/img/Bigstock_32428685.jpg') no-repeat center center fixed; background-size: cover; position: relative;">
        <div class="signupform" style="position: absolute; top: 50%; left: 0; right: 0; text-align: center;">
            <div><h1>Need some grain?</h1></div>
        </div>
    </div>
		<div class="outer">
