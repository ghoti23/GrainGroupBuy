                ...
                <div class="span6">
                    <div class="box gradient">
                        <div class="title">
                            <div class="row-fluid">
                                <div class="span8">
                                    <h4><i class=" icon-bar-chart"></i><span>Strike Temperature Calculator</span></h4>
                                </div>
                            </div>
                            <!-- End .row-fluid -->
                        </div>
                        <!-- End .title -->
                        <div class="content">
                            Determine what your strike temperature will need to be to meet the desired mash-in temperature.
                            <div class="row-fluid">
                                <div class="span8">
